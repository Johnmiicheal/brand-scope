...
export default function CitationsPage() {
  ...
  return (
    <div className="mx-auto p-4 md:p-6 space-y-6">
        <div>
            <h1 className="text-3xl font-bold tracking-tight">Brand Mentions Analysis</h1>
            <p className="text-muted-foreground">
                Review where your brand is mentioned during initial analysis and discover new ones based on AI-generated search prompts.
            </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="bg-background">
            <CardHeader>
              ...
              <CardDescription>Potential search queries used to find new mentions.</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingAnalysis ? (
          ...
          <Card className="bg-background">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <ListChecks className="h-5 w-5 text-teal-500" /> Discovered Brand Mentions
              </CardTitle>
