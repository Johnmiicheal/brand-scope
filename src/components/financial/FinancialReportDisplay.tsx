...
export default function FinancialReportDisplay({ report }: FinancialReportDisplayProps) {
  ...
  return (
    <div className="mt-24">
      ...
      <div className="w-full overflow-x-auto py-6 no-scroll-bar">
        <motion.div
        ...
        >
          {report.map((item, index) => (
            <motion.a
              ...
              className="flex-shrink-0 w-[300px] border rounded-lg hover:shadow-md transition-all duration-200 group"
