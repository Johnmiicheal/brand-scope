      ...
      if (session?.user) {
        if (success && sessionId) {
          ...
          if (error) {
            ...
            setStatus("error");
            setMessage(
              "Could not verify your subscription. Please contact support."
            );
            return;
          }
          ...
          if (data) {
            setStatus("success");
            setMessage(
              "Your subscription was successful! You now have access to premium features."
            );
          } else {
          ...
          setStatus("error");
          setMessage(
            "You canceled the checkout process. Your subscription was not completed."
          );
        }
      }
    };
