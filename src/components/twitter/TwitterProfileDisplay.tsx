...
export default function ProfileDisplay({ rawText, username }: ProfileDisplayProps) {
  ...
  return (
    <div className="w-full bg-background border shadow-sm rounded-md overflow-hidden">
      {/* Header Banner */}
      ...
      <div className="px-6">
        ...
        {/* Bio */}
        {bio && (
          <p className="mt-4 text-gray-400 leading-relaxed">{bio}</p>
        )}
        ...
        <div className="mt-4 flex flex-wrap gap-6">
          ...
          <div className="flex items-center gap-1.5 text-blue-400/80">
            ...
            <span className="text-gray-500">Joined <span className="text-blue-400/80">{created_at}</span> </span>
          </div>
          )}
        </div>
