...
export default function YoutubeVideosDisplay({ videos }: YoutubeVideosDisplayProps) {
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl font-normal">YouTube Videos</h2>
          ...
          {validVideos.map((video, index) => {
            ...
            return (
              <motion.a
                ...
                className="flex-shrink-0 w-[350px] group rounded-md border shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden"
              ...
              >
                ...
                <div className="p-4 space-y-2">
                  <p className="text-base font-medium line-clamp-2 text-white/80 transition-colors duration-300">
